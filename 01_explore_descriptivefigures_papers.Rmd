...
Reference book to text mining in tidy format: [Text Mining with R](https://www.tidytextmining.com/tfidf.html)
...
ggplot(slice(non_stop_words_per_abstract, 1:60), aes(id, num_words, fill=year)) + 
  geom_col(show.legend = FALSE) +
  labs(x = NULL, y = "# words", title="Top60 abstracts by # words, by year") +
...
kable(slice(non_stop_words_per_abstract, 1:20),
  caption = "Top20 abstracts ordered by number of (significant) words after deleting stopwords.", 
