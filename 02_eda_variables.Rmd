...
md_top3_byyear$md2 <- factor(md_top3_byyear$md, levels = c('all', '4-Depressive disorders', '26-Various', '5-Anxiety disorders'))

md_top3_byyear %>%
    ggplot(aes(x=year, y=number_cases)) +
    geom_area(aes(fill=md2), colour="black", size=.2, alpha=.4) +
    scale_fill_brewer(palette="Greens", breaks=levels(md_top3_byyear$md2)) +
