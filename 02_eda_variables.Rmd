...
The *top3* MD are categorised in the DSH-5, and they all cover about `r round(n_top3/n_md * 100)` % (`r n_top3`).
...
md_top3 %>%
    ...
    # theme_minimal() +
    # labs(x=NULL, y=NULL, 
    #     title="TOP mental disorders ",
    #     subtitle="Ranked by counts",
    #     caption="Data from ...") +
...
_What ilneess are speciall mentioned in the apepr per category of mental diorder?_

### Mental disorders and the 23, 24, 25 c


### Mental disorders and phsycological framework

_Which is the coverage of CBT?_
_Which DMs are related to third wave theraphy and /or positive Psychotherapy?_

_How many apps are related to MD 4- Depreession
