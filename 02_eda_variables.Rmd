...
About `r percent(n_no_dsh5/n_papers)` % (N=`r n_no_dsh5`) are Dual, Multiple or Suicidal Behavior Disorder/Nonsuicidal Self-Injury. 
...
We look at MDs which are not categorised according to the DSH-5 (id equal to 23 or 24)
