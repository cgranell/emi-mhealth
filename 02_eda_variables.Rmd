...
We analyse two datasets: *ipapers2018_csdata* dataset that has `` `r nrow(ipapers2018_csdata)` `` records, and *ipapers2018_psydata* dataset that has `` `r nrow(ipapers2018_psydata)` `` records, and references.
...
#### BELOW THIS LINES IS NOT VALID
TODO: Merge `cs_data` and `psy_data` into all_data. Next, filter out thopse that are not invlcued oin both (psy_in, cs_in), and EDA (analysis, plots)
