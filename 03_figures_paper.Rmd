...
n_assessment_effectux <-nrow(filter(all_data, val_asstype=="EFFECT AND USABILITY/USER EXPERIENCE"))
n_assessment_ux <-nrow(filter(all_data, val_asstype=="USABILITY/USER EXPERIENCE"))
...
data_plot_tempdist$val_asstype <- fct_relevel(data_plot_tempdist$val_asstype, 
                                             c("NO ASSESSMENT", "USABILITY/USER EXPERIENCE", "EFFECT AND USABILITY/USER EXPERIENCE", "EFFECT"))
...
pal <- c("NO ASSESSMENT"="#AF8DC3", "USABILITY/USER EXPERIENCE"="#D9F0D3", "EFFECT AND USABILITY/USER EXPERIENCE"="#7FBF7B", "EFFECT"="#1B7837")
...
data_kp_barchart$val_asstype <- fct_relevel(data_kp_barchart$val_asstype, 
                                            c("NO", "USABILITY/USER EXPERIENCE", "EFFECT AND USABILITY/USER EXPERIENCE", "EFFECT"))
...
plot_barchart <- 
    data_plot_barchart %>%
      ggplot(aes(x=md_desc, y=proportion, fill=val_asstype)) + 
        ...
        geom_point(aes(y=proportion_sum), size=6, color="white", show.legend = F) +  # lightgray
        # geom_text(aes(label=number_cases), size=2.5, position=position_stack(vjust = 0.5)) +
        geom_text(aes(label=number_cases), size=2.5, position=position_stack(vjust = 0.5)) +
...
plot_barchart
plot_file_name <- "fig3_barchart.png"
ggsave(plot = plot_barchart, filename = plot_file_name, device = "png", path = here::here("figs"),
...
lbls_colors <- 
    ifelse(unique(data_kp_all$tech_type) %in% c("Learning", "Progress", "Personalization", "Assessment", "Prompting", "Health Care Provider \nCommunication", 
                   "In-Situ Use", "Social", "Context-Awareness", "Game",  "Virtual Reality", "Augmented Reality"), "#FC8D62",
...
kp_bubblechart <- 
    ...
    labs(#title="Mental disorders vs Technology", 
         ...
         caption="Source: authors") + 
    scale_color_manual(name="Technology-related\n dimensions", breaks=brks,
