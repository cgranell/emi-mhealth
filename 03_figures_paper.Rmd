...
This R notebook contains the code to produce the final fours figures of the paper.

## Data 

We analyse three datasets of the *emidata* package. The package code is available in a public [git](https://git-scm.com/) repo: [https://github.com/cgranell/emidata](https://github.com/cgranell/emidata): 
...
Alternatively to the barchart, thte lollipop plot below shows the percentatge over the total. 
...
Circular barplot (Example 3): Each cell means one occurance of the app in a paper.
