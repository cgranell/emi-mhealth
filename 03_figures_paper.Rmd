...
Barchart: Distribution of papers per mental disorders, colored by assessment type (`` `r levels(all_data$val_asstype)` ``).
...
kp_barchart
kp_file_name <- "fig1_barchart.png"
...
Barchat with proportions instead of absolute counts 
...
kp_barchart
kp_file_name <- "fig1_barchart_proportion_b.png"
ggsave(plot = kp_barchart, filename = kp_file_name, device = "png", path = here::here("figs"),
...
kp_linechart <-
    data_top_byyear %>%
        ...
        labs(title="Distribution top mental disorders per year", 
             subtitle = paste0("All vs. top mental disorders (", top_lbl,"). Dashed line denotes prediction in 2018"),
             x="Year", 
             y="Number of cases", 
             caption="Source: authors") + 
