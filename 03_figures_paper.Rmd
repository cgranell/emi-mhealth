...
```{r save_rda, echo=FALSE}

# 
# all_data <- 
#     all_data %>%
#     select(-id_loc, -md_mul, -md_sub, -fmw_cbt, -fmw_hum, -fmw_sys, -fmw_psy, -fmw_pos, -fmw_wav, -fmw_tra, -val_ed, -val_ass, -assessmenttypeid,
#            -id_co, -os_ios, -os_and, -type, -md_dsm5)
...
if (length(md_anal) > 0) {
    for (md in md_dif) {
        ...
        data_kp_anal <- add_row(data_kp_anal, md_desc=md, tech_type="anal_ml", cat="Types of analyses")
    }
}
...
dims_ordered <- c("Software features", "Built-In sensors", "Types of analyses")
...
kp_bubblechart <- 
    ...
    scale_color_manual(name="Technology-related\n dimensions", breaks=brks,
                       values = c("Software features"="#FC8D62","Built-In sensors"="#66C2A5", "Types of analyses"="#8DA0CB")) +
    # Which legend to show
