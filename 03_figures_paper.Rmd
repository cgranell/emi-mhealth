...
top6_proportion <- sum(lbls[1:6, "proportion_sum"]) 
top6_lbl <- paste0(round(top6_proportion*100,1), "%")
    ...
    data_kp_barchart %>%
      ggplot(aes(x=md_desc, y=proportion)) + 
        ...
        annotate("text", x = "Schizophrenia spectrum and other psychotic disorders", y = .17,
                 label = top6_lbl, color = "black", size = 3, hjust = -0.1, vjust = 1.2) +
...
kp_linechart
kp_file_name <- "fig2_linechart.png"
